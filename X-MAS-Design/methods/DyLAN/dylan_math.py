...
class DyLAN_MATH(MAS):
    ...
    def inference(self, query: str) -> str:
        """Process a math query and return the solution."""
        ...
        for i, agent_context in enumerate(agent_contexts):
            completion = self.call_llm(messages=agent_context, domain='math', function='evaluate', model_name=self.model_names[i])
        ...
        completion = self.call_llm(messages=[{"role": "user", "content": message}], domain='math', function='evaluate', model_name=self.model_names[-1])
